...
A list of tools that can be targeted by "Prompt Injection." They can also be used to generate interesting prompts.
...
Here is a list of basic prompts to test against NLP models.
...
- **Cross Plugin Request Forgery, e.g: Zapier**: 
    ```markdown
